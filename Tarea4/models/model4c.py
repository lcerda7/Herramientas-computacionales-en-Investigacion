...
class Model4c(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        # Reproject layer
        alg_params = {
            'INPUT': 'Remaining_fields_3af6d6c6_a684_4cdb_9bc2_5e7945a50911',
            'OPERATION': '',
        ...
        # Fix geometries
        alg_params = {
            'INPUT': 'Reprojected_b554bd8d_de8e_4fd1_8c76_49a58e688d31',
        ...
        alg_params = {
            ...
            'LAYER_NAME': '',
            'LAYER_OPTIONS': '',
            'OUTPUT': '/Users/gonzalorigirozzi/Desktop/Clase 4/OUTPUT/areas_out.csv',
        ...
        alg_params = {
            ...
            'INPUT': 'Fixed_geometries_eb9c270f_9bb0_44d2_bd94_ee7048bf4af4',
